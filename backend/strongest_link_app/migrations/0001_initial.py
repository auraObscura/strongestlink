...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_img', models.URLField(blank=True, default='https://res.cloudinary.com/strongest-link/image/upload/v1651852463/lgo5em5rwqeuiduqza71.png', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('attendees', models.ManyToManyField(blank=True, to='strongest_link_app.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
